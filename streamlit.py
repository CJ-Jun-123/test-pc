...
def display_bar_charts(avg_star_rating, num_verified, num_unverified):
  ...
  # Bar chart for Average Star Rating
  ...
  # Bar chart for Verified and Unverified Purchases
  ax[1].bar(['Verified Purchases', 'Unverified Purchases'], [num_verified, num_unverified], color=['green', 'red'])
